...
function SettingHeader (){
    ...
    return (
        <div className={`fixed ${sidebarOffsetClasses} flex flex-col lg:flex-row gap-6 items-center justify-between ${dark?"bg-gradient-to-r from-slate-900 via-gray-900 to-indigo-950":"bg-gradient-to-r from-purple-50  to-white"} py-7 sm:py-4 px-16 shadow-md transition-all duration-500`}>
        <div className='flex flex-col md:flex-row justify-center items-center gap-3'>
          <div className={`flex items-center justify-center h-10 w-10 ${dark?"bg-linear-to-r from-purple-800 via-blue-800 to-indigo-800":"bg-linear-to-r from-purple-200 via-blue-200 to-indigo-200"} rounded-lg`}>
          ...
          <div className={`flex justify-center items-center gap-2 px-4 py-2 rounded-xl  ${dark?"bg-linear-to-r from-purple-950 via-blue-950 to-indigo-950":"bg-linear-to-r from-purple-50  to-blue-50"}`}>
