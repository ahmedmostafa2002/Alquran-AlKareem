  ...
  return(
    <div className={`fixed z-50 w-full flex items-center justify-between ${theme === "light"?"bg-white":"bg-gradient-to-r from-slate-900 via-gray-900 to-indigo-950"} p-4 shadow-md ${dark?"shadow-purple-950":"shadow-gray-100"} transition-all duration-500`}>
     ...
     <div className="flex items-center">
      ...
      <button onClick={handleSideBar} className={`text-xl w-fit hidden lg:block font-bold ml-2 ${dark?"bg-gradient-to-r from-purple-300 via-blue-300 to-indigo-400":"bg-gradient-to-r from-purple-600 via-blue-600 to-indigo-700"} bg-clip-text text-transparent cursor-pointer`}>
